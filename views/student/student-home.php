                                ...
                                <div class="row align-items-center">
                                    <div class="col-md-12">
                                        <div class="page-header-title">
                                            <h5 class="m-b-10">Student Class Schedule</h5>
                                        </div>
                                        <ul class="breadcrumb">
                            ...
                            <div class="col-sm-9">
                                <div class="card">
                                    <div class="card-header d-flex justify-content-between align-items-center">
                                        <h5>Subjects Enrolled <i class="feather icon-folder"></i></h5>
...
<script>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        fetch('../../controllers/get-student-enrollment.php?id=<?php echo $_SESSION['id']; ?>')
